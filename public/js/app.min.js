...
window.loadKillboard=async function(t,e="#killTable tbody",i=10){if(!t)return void console.error("System ID is required to load the killboard.");async function a(t,e){const i=`https://esi.evetech.net/latest/killmails/${t}/${e}/?datasource=tranquility`,a=await fetch(i);return await a.json()}function n(t,e=null,i=null){const a=document.createElement("td"),n=document.createElement("div");n.classList.add("image-container"),i&&n.classList.add(i);const l=document.createElement("img");if(l.src=t,e){const t=document.createElement("a");t.href=e,t.target="_blank",t.appendChild(l),n.appendChild(t)}else n.appendChild(l);return a.appendChild(n),a}function l(t){const e=document.createElement("td"),i=document.createElement("div");return i.classList.add("image-container"),i.style.display="flex",i.style.flexDirection="column",i.style.alignItems="center",t.forEach((({url:t,link:e,className:a})=>{const n=document.createElement("div");n.classList.add("image-container"),a&&n.classList.add(a);const l=document.createElement("img");if(l.src=t,e){const t=document.createElement("a");t.href=e,t.target="_blank",t.appendChild(l),n.appendChild(t)}else n.appendChild(l);i.appendChild(n)})),e.appendChild(i),e}clearKillboard(e);const c=await async function(t){const e=await fetch(`https://zkillboard.com/api/npc/0/solarSystemID/${t}/kills/pastSeconds/86400/`);return await e.json()}(t),o=document.querySelector(e),r=c.slice(0,i);for(const t of r){const{killmail_id:e,zkb:{hash:i,totalValue:c=0}}=t;try{const t=await a(e,i),r=t.attackers.find((t=>t.character_id&&t.ship_type_id))||{},d=t.victim||{},s=document.createElement("tr"),p=new Date(t.killmail_time),h=p.toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1,timeZone:"UTC"}),m=p.toLocaleString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric",timeZone:"UTC"}),u=document.createElement("td");u.innerHTML=`\n      <div id="killTime">${h} UTC</div>\n      <div id="killDate">${m}</div>\n      <div id="killValue">${c.toLocaleString()} ISK</div>\n    `,u.style.textAlign="center",s.appendChild(u),s.appendChild(l([{url:`https://images.evetech.net/corporations/${d.corporation_id??0}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${d.corporation_id??0}`,className:"corporation-logo"},{url:`https://images.evetech.net/alliances/${d.alliance_id??0}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${d.alliance_id??0}/`,className:"alliance-logo"}])),s.appendChild(n(`https://images.evetech.net/characters/${d.character_id??0}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${d.character_id??0}`,"victim-portrait")),s.appendChild(n(`https://images.evetech.net/types/${d.ship_type_id??0}/render?size=64`,`https://zkillboard.com/kill/${e}`,"victim-image")),s.appendChild(n(`https://images.evetech.net/types/${r.ship_type_id??0}/render?size=64`,`https://zkillboard.com/kill/${e}`,"attacker-image")),s.appendChild(n(`https://images.evetech.net/characters/${r.character_id??0}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${r.character_id??0}`,"attacker-portrait")),s.appendChild(l([{url:`https://images.evetech.net/corporations/${r.corporation_id??0}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${r.corporation_id??0}`},{url:`https://images.evetech.net/alliances/${r.alliance_id??0}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${r.alliance_id??0}/`}])),o.appendChild(s)}catch(t){console.warn(`Failed to fetch killmail ${e}:`,t)}}},window.clearKillboard=function(t="#killTable tbody"){const e=document.querySelector(t);e&&(e.innerHTML="")},window.addEventListener("DOMContentLoaded",(()=>{loadKillboard()}));
var activity=new function(){this.graph,this.options,this.view,this.span=24,this.columns=[{id:"time",label:"Time",role:"domain",type:"string",calc:function(t,i){return t.getValue(i,0)+"h"}},{id:"jumps",label:"Jumps",role:"data",type:"number",sourceColumn:1,column:1,title:"Jumps"},{id:"podkills",label:"Pod Kills",role:"data",type:"number",sourceColumn:2,column:2,title:"Pod Kills"},{id:"shipkills",label:"Ship Kills",role:"data",type:"number",sourceColumn:3,column:3,title:"Ship Kills"},{id:"npckills",label:"NPC Kills",role:"data",type:"number",sourceColumn:4,column:4,title:"NPC Kills"}],this.getData=function(t,i){t=void 0!==t?t:this.span,i=void 0===i||i;return activity.graph?$.ajax({url:"activity_graph.php",data:{systemID:viewingSystemID,time:t},type:"GET",dataType:"JSON",cache:i}).done((function(t){t&&!0===t.systemData?(t.rows.reverse(),activity.view=new google.visualization.DataView(new google.visualization.DataTable(t)),activity.view.setColumns(activity.columns),activity.graph.draw(activity.view,activity.options),$("#graphBoard").css("display","block"),$("#killBoard").css("display","none")):($("#graphBoard").css("display","none"),$("#killBoard").css("display","block"))})).fail((function(t,i,a){console.error("AJAX request failed: "+i,a),$("#graphBoard").css("display","none"),$("#killBoard").css("display","block")})):(setTimeout((function(){activity.getData(t,i)}),500),!1)},this.selectHandler=function(){var t=activity.graph.getSelection();if(t[0]&&null==t[0].row){var i=t[0].column;activity.columns[i].sourceColumn?(activity.columns[i].label=activity.columns[i].title+" (off)",delete activity.columns[i].sourceColumn):(activity.columns[i].sourceColumn=activity.columns[i].column,activity.columns[i].label=activity.columns[i].title),activity.view.setColumns(activity.columns),activity.options.animation.duration=0,activity.graph.draw(activity.view,activity.options),activity.options.animation.duration=500}},this.init=function(){activity.graph=new google.visualization.AreaChart(document.getElementById("activityGraph")),activity.options={isStacked:!1,backgroundColor:"transparent",hAxis:{textStyle:{color:"#999",fontName:"Verdana",fontSize:10},showTextEvery:3},vAxis:{textStyle:{color:"#666",fontName:"Verdana",fontSize:10},viewWindowMode:"maximized",viewWindow:{min:0},maxValue:5},gridlineColor:"#454545",pointSize:2,lineWidth:1,height:150,chartArea:{left:"10%",top:"5%",width:"88%",height:"85%"},legend:{position:"in",textStyle:{color:"#CCC",fontName:"Verdana",fontSize:8.5}},animation:{duration:500,easing:"inAndout"},tooltip:{showColorCode:!0},annotations:{style:"line",textStyle:{fontSize:12,color:"#ccc"},domain:0},focusTarget:"category"},google.visualization.events.addListener(activity.graph,"select",activity.selectHandler),activity.getData(activity.span)},this.time=function(t){switch(t){case 24:this.options.hAxis.showTextEvery=3;break;case 48:this.options.hAxis.showTextEvery=6;break;case 168:this.options.hAxis.showTextEvery=24}this.span=t,this.getData(t)},this.redraw=function(){this.graph.draw(this.view,this.options)},this.refresh=function(t){this.getData(this.span,t)},google.charts.setOnLoadCallback(this.init)};
