...
var chain=new function(){var e=this;this.map,this.view,this.drawing,this.data={},thirdPartySuppliers=[eveScout];const i={orgChart:new ChainMapRendererOrgchart(this),orgChartTop:new ChainMapRendererOrgchartTop(this),orgChartSide:new ChainMapRendererOrgchartSide(this),radial:new ChainMapRendererRadial(this)};this.renderer=i[options.chain.renderer],this.renderer.switchTo(),this.useRenderer=function(s){if(!i[s])throw"Unknown renderer "+s;e.renderer!=i[s]&&(e.renderer.switchFrom(),e.renderer=i[s],e.renderer.switchTo(),e.redraw())},this.activity=function(e){for(var i=0,s=(t=document.querySelectorAll("#chainMap .nodeActivity span")).length;i<s;++i)t[i].className=t[i].className+" invisible";var t;for(i=0,s=(t=document.querySelectorAll("#chainMap [data-nodeid]")).length;i<s;++i){var a=t[i].getAttribute("data-nodeid");if(e[a]){var n=e[a].shipJumps,r=e[a].podKills,c=e[a].shipKills,o=e[a].npcKills,l=t[i].getElementsByClassName("nodeActivity")[0];if(n>0){var d=l.getElementsByClassName("jumps")[0];d.className=d.className.replace(/invisible/g,""),d.setAttribute("data-tooltip",n+" Jumps")}if(r>0){var h=l.getElementsByClassName("pods")[0];h.className=h.className.replace(/invisible/g,""),h.setAttribute("data-tooltip",r+" Pod Kills")}if(c>0){var p=l.getElementsByClassName("ships")[0];p.className=p.className.replace(/invisible/g,""),p.setAttribute("data-tooltip",c+" Ship Kills")}if(o>0){var m=l.getElementsByClassName("npcs")[0];m.className=m.className.replace(/invisible/g,""),m.setAttribute("data-tooltip",o+" NPC Kills")}}}return SystemActivityToolTips.attachedElements&&SystemActivityToolTips.attachedElements.length>0&&SystemActivityToolTips.detach($("#chainMap .whEffect")),SystemActivityToolTips.attach($("#chainMap .nodeActivity > span[data-tooltip]:not(.invisible)")),e},this.occupied=function(e){for(var i in $("#chainMap [data-icon='user'], #chainMap [data-icon='user'] + .badge").addClass("invisible"),e)$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user']").removeClass("invisible"),$("#chainMap [data-nodeid='"+e[i].systemID+"'] [data-icon='user'] + .badge").removeClass("invisible").text(e[i].count);return OccupiedToolTips.attach($("#chainMap [data-icon='user']:not(.invisible)")),e},this.flares=function(e){if($("#chainMap div.node").removeClass("redNode yellowNode greenNode"),$("#chainGrid tr").removeClass("red yellow green"),e)for(var i in e.flares){var s=e.flares[i].systemID,t=e.flares[i].flare,a=($("#chainMap [data-nodeid="+s+"]").addClass(t+"Node").parent().index()-1)/3*2;a>0&&$("#chainGrid tr:eq("+a+")").addClass(t).next().addClass(t)}return e},this.grid=function(){if(0==options.chain.gridlines)return $("#chainGrid tr").addClass("hidden"),!1;$("#chainGrid tr").removeClass("hidden");var e=Math.max(0,2*$(".google-visualization-orgchart-table tr:has(.node)").length-1);$("#chainGrid tr:gt("+e+")").addClass("hidden")},this.nodes=function(e){var i={cols:[{label:"System",type:"string"},{label:"Parent",type:"string"}],rows:[]},s=[];function t(e,i){if(!e||!tripwire.systems[e])return!1;const s=options.chain.tabs[options.chain.active];return a(e,i,null,null,s&&0!=s.systemID&&0>s.systemID.indexOf(",")?options.chain.tabs[options.chain.active].name:void 0,"&nbsp;",["top-level"])}function a(e,i,s,t,a,n,r){const c=systemAnalysis.analyse(e);var o="<span class='"+c.systemTypeClass+"'>"+c.systemTypeName+c.systemTypeModifiers.join("")+"</span>";a=_.escape(a);const l="name"==options.chain.sigNameLocation?a||(c.name?c.name:"&nbsp;"):"name_prefix"==options.chain.sigNameLocation&&a?a+(c.name?" - "+c.name:""):c.name?c.name:"&nbsp;";var d={v:i,systemID:e},h="<div id='node"+i+"' data-nodeid='"+e+"'"+(s?" data-sigid='"+s+"'":"")+(t?" data-inSigid='"+t+"'":"")+" class='node "+(r||[]).join(" ")+"'><div class='nodeIcons'><div style='float: left;'>"+systemRendering.renderEffect(c,"i")+"</div><div style='float: right;'><i data-icon='user' class='invisible'></i><span class='badge invisible'></span></div></div><h4 class='nodeClass'>"+o+"</h4><h4 class='nodeSystem'>"+(c.name?"<a href='.?system="+c.name+"'>"+l+"</a>":l)+"</h4><h4 class='nodeType'>"+n+"</h4><div class='statics'>"+function(e){if(!e)return"";if(e.length>4)return'<span class="multi-static">+</span>';const i={"High-Sec":"H","Low-Sec":"L","Null-Sec":"N",Triglavian:"▼","Class-1":"1","Class-2":"2","Class-3":"3","Class-4":"4","Class-5":5,"Class-6":6},s={H:"hisec",L:"lowsec",N:"nullsec","▼":"triglavian"};return e.map((function(e){const t=i[appData.wormholes[e].leadsTo];return'<span class="'+(s[t]||"class-"+t)+'" data-tooltip="'+appData.wormholes[e].leadsTo+" via "+e+'">'+t+"</span>"})).join("")}(c.name?c.statics:[])+"</div><div class='nodeActivity'><span class='jumps invisible'>&#9679;</span>&nbsp;<span class='pods invisible'>&#9679;</span>&nbsp;&nbsp;<span class='ships invisible'>&#9679;</span>&nbsp;<span class='npcs invisible'>&#9679;</span></div></div>";return d.f=h,d}function n(e,i,s){var t=guidance.findShortestPath(tripwire.map.shortest,s-3e7,i.child.systemID-3e7);if(!t)return null;var a={calculated:!0,life:"Gate",parent:{}};return a.parent.id=i.child.id,a.parent.systemID=i.child.systemID,a.parent.name=i.child.name,a.parent.type=i.child.type,a.parent.nth=i.child.nth,a.child={},a.child.id=++e,a.child.systemID=s,a.child.name=tripwire.systems[s].name,a.child.path=t,a.child.jumps=t.length-1,a.child.nth=null,{childID:e,calcNode:a}}function r(e){if(e[0]<=0)return!1;var i=parseInt(e[1]),s=o.length;const t=[],a=function(e){$("#show-viewing").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[viewingSystemID].class&&!tripwire.systems[e.child.systemID].class&&viewingSystemID!=e.child.systemID&&((t=n(s,e,viewingSystemID))&&(s=t.childID,d.push(t.calcNode),o.push([0,s])));if($("#show-favorite").hasClass("active")&&tripwire.systems[e.child.systemID]&&!tripwire.systems[e.child.systemID].class)for(var i in options.favorites){var t;if(!(tripwire.systems[options.favorites[i]].regionID>=11e6||tripwire.systems[e.child.systemID].regionID>=11e6||options.favorites[i]==e.child.systemID))(t=n(s,e,options.favorites[i]))&&(s=t.childID,d.push(t.calcNode),o.push([0,s]))}};for(var r in l){var c=l[r];if(-1==$.inArray(c.id,h)){var p,m,y,u,v,f,g,I;if("secondary"==c.parent?(p=tripwire.client.signatures[c.secondaryID],m=tripwire.client.signatures[c.initialID]):(p=tripwire.client.signatures[c.initialID],m=tripwire.client.signatures[c.secondaryID]),y=c.type,u="K162",p&&p.systemID==e[0])v=p,f=m,g=u,I=y;else{if(!m||m.systemID!=e[0])continue;v=m,f=p,I=u,g=y}if(!p||!m){console.warn("Bad wormhole - check sigs "+c.initialID+" and "+c.secondaryID);continue}var D={};D.id=c.id,D.life=c.life,D.mass=c.mass,D.time=v.modifiedTime,D.parent={},D.parent.id=i,D.parent.systemID=tripwire.systems[v.systemID]?v.systemID:v.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),D.parent.name=f.name,D.parent.type=g,D.parent.nth=null,D.parent.signatureID=f.signatureID,D.parent.sigIndex=f.id,D.child={},D.child.id=++s,D.child.systemID=tripwire.systems[f.systemID]?f.systemID:f.systemID+"|"+Math.floor(Math.random()*Math.floor(1e4)),D.child.name=v.name,D.child.type=I,D.child.nth=null,D.child.signatureID=v.signatureID,D.child.sigIndex=v.id,d.push(D),o.push([D.child.systemID,D.child.id,e[2]]),h.push(D.id),tripwire.systems[f.systemID]&&t.push(1*f.systemID),a(D)}}thirdPartySuppliers.forEach((function(n){const r={parentID:i,nextChildID:++s},c=n.findLinks(1*e[0],r);if(c){s=r.nextChildID-1;for(var l=0;l<c.length;l++){var p=c[l];0>h.indexOf(p.id)&&(0>t.indexOf(p.child.systemID)&&(p.thirdParty=n.nodeNameSuffix,d.push(p),o.push([p.child.systemID,p.child.id,e[2]]),t.push(p.child.systemID),a(p)),h.push(p.id))}}}))}if($("#chainTabs .current").length>0){var c=$("#chainTabs .current .name").data("tab").toString().split(","),o=[],l=e,d=[],h=[];if(0==c){let s=0;Object.keys(e).slice().forEach((a=>{const n=tripwire.client.signatures[e[a].initialID],r=tripwire.client.signatures[e[a].secondaryID];n&&tripwire.systems[n.systemID]&&void 0===tripwire.systems[n.systemID].class?(s++,i.rows.push({c:[t(n.systemID,s),{v:null}]}),o.push([n.systemID,s,n.systemID])):r&&tripwire.systems[r.systemID]&&void 0===tripwire.systems[r.systemID].class&&(s++,i.rows.push({c:[t(r.systemID,s),{v:null}]}),o.push([r.systemID,s,r.systemID]))}))}else for(var p in c)i.rows.push({c:[t(c[p],parseInt(p)+1),{v:null}]}),o.push([c[p],parseInt(p)+1,c[p]]);for(var m=0;m<o.length;m++)r(o[m])}else{$("#chainError").hide();var y={c:[]},u=viewingSystemID;y.c.push(t(u,1),{v:null}),i.rows.push(y);for(o=[[u,1]],l=e,d=[],h=[],m=0;m<o.length;++m)r(o[m])}const v={};for(var p in d){var f=d[p];y={c:[]};sigText="",1==options.chain.showGatesBridges&&"GATE"==f.child.type||"GATE"==f.parent.type?sigText="GATE":1==options.chain.showGatesBridges&&"BRDG"==f.child.type||"BRDG"==f.parent.type?sigText="BRIDGE":sigText="id"==options.chain["node-reference"]?f.child.signatureID?f.child.signatureID.substring(0,3):"???":f.child.type||"(?)";const e=f.child.path?systemRendering.renderPath(f.child.path):(f.child.sigIndex?"<a href='#' onclick='sigDialog.openSignatureDialog({data: { signature: "+f.child.sigIndex+', mode: "update" }}); return false;\'>':"")+_.escape(f.child.name&&"ref"==options.chain.sigNameLocation?f.child.name:f.child.name&&"ref_prefix"==options.chain.sigNameLocation?f.child.name+" - "+sigText:sigText)+(f.child.sigIndex?"</a>":""),t=f.calculated?["calc"]:v[f.child.systemID]?["loop"]:[];f.thirdParty&&t.push("third-party","third-party-"+f.thirdParty);var g=[];"critical"==f.life&&g.push("eol"),"critical"==f.mass?g.push("critical"):"destab"==f.mass&&g.push("destab");const n=wormholeAnalysis.wormholeFromTypePair(f.parent.type,f.child.type)||wormholeAnalysis.likelyWormhole(f.parent.systemID,f.child.systemID);n.jump&&(g.push("jm-"+n.jump/1e6+"kt"),5e6==n.jump&&g.push("frig"));const r=(v[f.parent.systemID]||{chainModifiers:[]}).chainModifiers;y.chainModifiers=g.concat(r.filter((function(e){return g.indexOf(e)<0}))),y.chainModifiers.forEach((function(e){g.push(e+"-chain")}));const c=a(f.child.systemID,f.child.id,f.id,f.child.sigIndex,f.child.name,e,t.concat(g));var I={v:f.parent.id};y.c.push(c,I),i.rows.push(y),s.push(Array(c.v,I.v,g,f.id));const o=(v[f.parent.systemID]||{pathHome:[]}).pathHome;y.pathHome=o.concat(f.child),f.calculated||(v[f.child.systemID]=y)}s.reverse();const D=Object.keys(v).filter((function(e){return e<31e6}));return{map:i,lines:s,systemsInChainMap:v,exits:D}},this.setActiveTab=function(i){$("#chainTabs .tab").removeClass("current"),options.chain.active=i,null!=i&&$("#chainTabs .tab").eq(i).addClass("current"),options.save(),e.redraw(),tripwire.parse(tripwire.client,"refresh")},this.redraw=function(){this.useRenderer(options.chain.renderer);var e=$.extend(!0,{},this.data);e.map=$.extend(!0,{},e.rawMap),this.draw(e)};var s=null;this.draw=function(i){i=void 0!==i?i:{};if(clearTimeout(s),!this.renderer.ready()||Object.keys(i.map||{}).length&&!tripwire.client.signatures)s=setTimeout((function(){e.draw(i)}),100);else{if(i.map){this.drawing=!0,this.data.rawMap=$.extend(!0,{},i.map),Object.sort(i.map,"id"),$.extend(i,this.nodes(i.map)),$.extend(this.data,i);const e=options.chain.tabs[options.chain.active]&&options.chain.tabs[options.chain.active].collapsed||[];this.renderer.draw(i.map,i.lines,e),this.grid(),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),WormholeRouteToolTips.attach($("#chainMap .path span[data-tooltip]")),SystemActivityToolTips.attach($("#chainMap .nodeClass span[data-tooltip]")),this.drawing=!1,systemPanel.update()}!this.data.activity||new Date>this.data.activity.expires?(i.activity={},tripwire.esi.universeJumps().done((function(e,s,t){i.activity.expires=new Date(t.getResponseHeader("expires")),$.each(e,(function(s){i.activity[e[s].system_id]={systemID:e[s].system_id,shipJumps:e[s].ship_jumps}}))})).then((function(){return tripwire.esi.universeKills().done((function(e){$.each(e,(function(s){i.activity[e[s].system_id]?(i.activity[e[s].system_id].podKills=e[s].pod_kills,i.activity[e[s].system_id].shipKills=e[s].ship_kills,i.activity[e[s].system_id].npcKills=e[s].npc_kills):i.activity[e[s].system_id]={systemID:e[s].system_id,podKills:e[s].pod_kills,shipKills:e[s].ship_kills,npcKills:e[s].npc_kills}}))}))})).then((function(){e.data.activity=e.activity(i.activity)}))):i.map&&e.activity(this.data.activity),i.occupied&&(this.data.occupied=this.occupied(i.occupied)),i.flares&&(this.data.flares=this.flares(i.flares)),1==options.chain.commentFlare&&commentData().then((function(e){})).catch((function(e){console.error("Error fetching or processing comments:",e)}))}},this.updateCollapsed=function(i){options.chain.tabs[options.chain.active]&&(options.chain.tabs[options.chain.active].collapsed=i),$("#chainMap [data-nodeid='"+viewingSystemID+"']").parent().addClass("currentNode"),WormholeTypeToolTips.attachedElements&&WormholeTypeToolTips.attachedElements.length>0&&WormholeTypeToolTips.detach($("#chainMap .whEffect")),WormholeTypeToolTips.attach($("#chainMap .whEffect[data-icon]")),e.activity(e.data.activity),1==options.chain.commentFlare&&commentData().then((function(e){})).catch((function(e){console.error("Error fetching or processing comments:",e)})),e.occupied(e.data.occupied),e.flares(e.data.flares),e.grid(),options.save()}};
...
const commentCache=new Map,commentCACHE_DURATION=6e4;function filterComments(e){const t=collectSystemIDs(),n=e.commentlist.commentlist.filter((e=>t.includes(e.systemID.toString())));return $("#chainMap div.node").removeClass("commentNode"),n.forEach((e=>{$("#chainMap [data-nodeid='"+e.systemID+"']").addClass("commentNode")})),n}bustCache=function(e){e.data=null,e.timestamp=0,console.log("Cache busted")},commentData=function(){const e=Date.now();return commentCache.data&&e-commentCache.timestamp<6e4?Promise.resolve(filterComments(commentCache.data)):$.ajax({url:"commentlist.php",type:"GET",dataType:"JSON"}).then((function(e){return commentCache.data=e,commentCache.timestamp=Date.now(),filterComments(e)})).fail((function(e,t,n){return console.error("AJAX request failed: "+t,n),[]}))},collectSystemIDs=function(){const e=[];return document.querySelectorAll("#chainMap [data-nodeid]").forEach((t=>{const n=t.getAttribute("data-nodeid");n&&!e.includes(n)&&e.push(n)})),e};
let systemID,loadedKills=0,allKills=[];const zkillCache=new Map,zkillCACHE_DURATION=3e4;async function getZkillData(e){const t=Date.now(),l=zkillCache.get(e);if(l&&t-l.timestamp<3e4)return l.data;try{const l=await fetch(`/killboard.php?systemID=${e}`);if(!l.ok)throw new Error(`HTTP error! status: ${l.status}`);const a=await l.json();if(a.error)throw new Error(a.error);return zkillCache.set(e,{data:a,timestamp:t}),a}catch(e){return console.error("Error fetching killboard data:",e),[]}}function createImageCell(e,t=null,l=null){const a=document.createElement("td"),i=document.createElement("div");i.classList.add("image-container"),l&&l.split(" ").forEach((e=>{i.classList.add(e)}));const n=document.createElement("img");if(n.src=e,t){const e=document.createElement("a");e.href=t,e.target="_blank",e.appendChild(n),i.appendChild(e)}else i.appendChild(n);return a.appendChild(i),a}function createStackedImageCell(e){const t=document.createElement("td"),l=document.createElement("div");return l.classList.add("image-container"),l.style.display="flex",l.style.flexDirection="column",l.style.alignItems="center",e.forEach((({url:e,link:t,className:a})=>{const i=document.createElement("div");i.classList.add("image-container"),a&&i.classList.add(a);const n=document.createElement("img");if(n.src=e,t){const e=document.createElement("a");e.href=t,e.target="_blank",e.appendChild(n),i.appendChild(e)}else i.appendChild(n);l.appendChild(i)})),t.appendChild(l),t}window.loadKillboard=async function(e,t="#killTable tbody",l=10){if(e&&(systemID=e,loadedKills=0,allKills=[]),!systemID)return void console.error("System ID is required to load the killboard.");0===loadedKills&&(clearKillboard(t),allKills=await getZkillData(systemID));const a=document.querySelector(t),i=document.getElementById("ignoreNPCKills").checked;let n=allKills.kills.slice(loadedKills);i&&(n=n.filter((e=>1!==e.npc))),n=n.slice(0,l);for(const e of n)try{const t=document.createElement("tr");t.className="time-value-row",t.setAttribute("data-killmail-id",e.killmail_id);const l=document.createElement("td");l.colSpan=7;const i=new Date(e.killmail_time),n=i.toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1,timeZone:"UTC"}),c=i.toLocaleString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric",timeZone:"UTC"});l.innerHTML=`\n      <div class="time-value-container">\n        <span class="kill-time">${n} UTC</span>\n        <span class="kill-date">${c}</span>\n        <span class="kill-value">${Number(e.total_value).toLocaleString()} ISK</span>\n      </div>\n    `,t.appendChild(l),a.appendChild(t);const o=document.createElement("tr");o.className="kill-row",o.setAttribute("data-killmail-id",e.killmail_id);const r=[{url:`https://images.evetech.net/corporations/${e.victim_corp}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${e.victim_corp}/`,className:"corporation-logo"}];e.victim_alliance&&"0"!==e.victim_alliance&&r.push({url:`https://images.evetech.net/alliances/${e.victim_alliance}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${e.victim_alliance}/`,className:"alliance-logo"}),o.appendChild(createStackedImageCell(r)),o.appendChild(createImageCell(`https://images.evetech.net/characters/${e.victim_id}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${e.victim_id}/`,"victim-portrait")),o.appendChild(createImageCell(`https://images.evetech.net/types/${e.victim_ship}/render?size=64`,`https://zkillboard.com/kill/${e.killmail_id}/`,"victim-image"));const s=createImageCell(`https://images.evetech.net/types/${e.attacker_ship}/render?size=64`,`https://zkillboard.com/kill/${e.killmail_id}/`,"attacker-image");if(1===e.npc){const e=document.createElement("div");e.className="attacker-count npc",e.textContent="NPC",s.querySelector(".image-container").appendChild(e)}else if(1==e.total_attackers){const e=document.createElement("div");e.className="attacker-count solo",e.textContent="Solo",s.querySelector(".image-container").appendChild(e)}else{const t=document.createElement("div");t.className="attacker-count",t.textContent=e.total_attackers,s.querySelector(".image-container").appendChild(t)}o.appendChild(s),o.appendChild(createImageCell(`https://images.evetech.net/characters/${e.attacker_id}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${e.attacker_id}/`,"attacker-portrait"));const d=[{url:`https://images.evetech.net/corporations/${e.attacker_corp}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${e.attacker_corp}/`,className:"corporation-logo"}];e.attacker_alliance&&"0"!==e.attacker_alliance&&d.push({url:`https://images.evetech.net/alliances/${e.attacker_alliance}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${e.attacker_alliance}/`,className:"alliance-logo"}),o.appendChild(createStackedImageCell(d)),a.appendChild(o)}catch(e){console.warn("Failed to process killmail:",e)}loadedKills+=n.length;const c=document.getElementById("loadMoreKills");if(c){const e=i?allKills.kills.filter((e=>1!==e.npc)).length-loadedKills:allKills.kills.length-loadedKills;c.textContent=e<=0?"All Kills Loaded!":"Load More!",c.disabled=e<=0}},window.clearKillboard=function(e="#killTable tbody"){const t=document.querySelector(e);t&&(t.innerHTML=""),loadedKills=0,allKills=[]},window.addEventListener("DOMContentLoaded",(()=>{const e=document.getElementById("loadMoreKills");e&&e.addEventListener("click",(()=>{loadKillboard(null,"#killTable tbody",10)}));const t=document.getElementById("ignoreNPCKills");t&&t.addEventListener("change",(()=>{loadedKills=0,loadKillboard(systemID)}))})),window.initializeKillboard=function(e){systemID=e,loadedKills=0,allKills=[],loadKillboard(systemID)};
function signaturePairsForSystem(e){return $.map(tripwire.client.signatures,(function(i){if(i.systemID==e){var t=$.map(tripwire.client.wormholes,(function(e){if(e.initialID==i.id||e.secondaryID==i.id)return e}))[0],s=i.id==t.initialID?tripwire.client.signatures[t.secondaryID]:tripwire.client.signatures[t.initialID],r=s.systemID;return console.log("signature",i),{otherSystemID:r,signature:i,wormhole:t,otherSignature:s}}}))}tripwire.addGatesForCurrentSystem=function(){if(tripwire.isRefreshing)return;const e=guidance.connections(tripwire.map.shortest,viewingSystemID);if(!e.length)return;const i=signaturePairsForSystem(viewingSystemID);var t={signatures:{add:[],update:[]},systemID:viewingSystemID},s=[];if(e.map((e=>{systemAnalysis.analyse(e.systemID);e.closed||($.map(i,(function(i){if(i.otherSystemID==e.systemID)return i}))[0]||t.signatures.add.push({wormhole:{type:"GATE",parent:"initial",life:"stable",mass:"stable"},signatures:[{signatureID:"gat",systemID:viewingSystemID,type:"wormhole",lifeLength:60*options.signatures.pasteLife*60},{signatureID:"gat",systemID:e.systemID,type:"wormhole",lifeLength:60*options.signatures.pasteLife*60}]}))})),t.signatures.add.length||t.signatures.update.length){tripwire.refresh("refresh",t,(function(e){e.resultSet&&1==e.resultSet[0].result&&($("#undo").removeClass("disabled"),e.results&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"add",signatures:e.results}):tripwire.signatures.undo[viewingSystemID]=[{action:"add",signatures:e.results}]),s.length&&(viewingSystemID in tripwire.signatures.undo?tripwire.signatures.undo[viewingSystemID].push({action:"update",signatures:s}):tripwire.signatures.undo[viewingSystemID]=[{action:"update",signatures:s}]),sessionStorage.setItem("tripwire_undo",JSON.stringify(tripwire.signatures.undo)))}),(function(e){tripwire.isRefreshing=!1}))}else tripwire.isRefreshing=!1};
var activity=new function(){this.graph,this.options,this.view,this.span=24,this.columns=[{id:"time",label:"Time",role:"domain",type:"string",calc:function(t,i){return t.getValue(i,0)+"h"}},{id:"jumps",label:"Jumps",role:"data",type:"number",sourceColumn:1,column:1,title:"Jumps"},{id:"podkills",label:"Pod Kills",role:"data",type:"number",sourceColumn:2,column:2,title:"Pod Kills"},{id:"shipkills",label:"Ship Kills",role:"data",type:"number",sourceColumn:3,column:3,title:"Ship Kills"},{id:"npckills",label:"NPC Kills",role:"data",type:"number",sourceColumn:4,column:4,title:"NPC Kills"}],this.columns2=[{id:"time",label:"Time",role:"domain",type:"string",calc:function(t,i){return t.getValue(i,0)+"h"}},{id:"podkills",label:"Pod Kills",role:"data",type:"number",sourceColumn:2,column:2,title:"Pod Kills"},{id:"shipkills",label:"Ship Kills",role:"data",type:"number",sourceColumn:3,column:3,title:"Ship Kills"},{id:"npckills",label:"Kills By NPC's",role:"data",type:"number",sourceColumn:4,column:4,title:"NPC Kills"}],this.getData=function(t,i){t=void 0!==t?t:this.span,i=void 0===i||i;return activity.graph?$.ajax({url:"activity_graph.php",data:{systemID:viewingSystemID,time:t},type:"GET",dataType:"JSON",cache:i}).done((function(t){t&&!0===t.systemData?(t.rows.reverse(),activity.view=new google.visualization.DataView(new google.visualization.DataTable(t)),activity.view.setColumns(activity.columns),activity.graph.draw(activity.view,activity.options)):(t.rows.reverse(),activity.view=new google.visualization.DataView(new google.visualization.DataTable(t)),activity.view.setColumns(activity.columns2),activity.graph.draw(activity.view,activity.options))})).fail((function(t,i,e){console.error("AJAX request failed: "+i,e)})):(setTimeout((function(){activity.getData(t,i)}),500),!1)},this.selectHandler=function(){var t=activity.graph.getSelection();if(t[0]&&null==t[0].row){var i=t[0].column;activity.columns[i].sourceColumn?(activity.columns[i].label=activity.columns[i].title+" (off)",delete activity.columns[i].sourceColumn):(activity.columns[i].sourceColumn=activity.columns[i].column,activity.columns[i].label=activity.columns[i].title),activity.view.setColumns(activity.columns),activity.options.animation.duration=0,activity.graph.draw(activity.view,activity.options),activity.options.animation.duration=500}},this.init=function(){activity.graph=new google.visualization.AreaChart(document.getElementById("activityGraph")),activity.options={isStacked:!1,backgroundColor:"transparent",hAxis:{textStyle:{color:"#999",fontName:"Verdana",fontSize:10},showTextEvery:3},vAxis:{textStyle:{color:"#666",fontName:"Verdana",fontSize:10},viewWindowMode:"maximized",viewWindow:{min:0},maxValue:5},gridlineColor:"#454545",pointSize:2,lineWidth:1,height:150,chartArea:{left:"10%",top:"5%",width:"88%",height:"85%"},legend:{position:"in",textStyle:{color:"#CCC",fontName:"Verdana",fontSize:8.5}},animation:{duration:500,easing:"inAndout"},tooltip:{showColorCode:!0},annotations:{style:"line",textStyle:{fontSize:12,color:"#ccc"},domain:0},focusTarget:"category"},google.visualization.events.addListener(activity.graph,"select",activity.selectHandler),activity.getData(activity.span)},this.time=function(t){switch(t){case 24:this.options.hAxis.showTextEvery=3;break;case 48:this.options.hAxis.showTextEvery=6;break;case 168:this.options.hAxis.showTextEvery=24}this.span=t,this.getData(t)},this.redraw=function(){this.graph.draw(this.view,this.options)},this.refresh=function(t){this.getData(this.span,t)},google.charts.setOnLoadCallback(this.init)};
