...
window.loadKillboard=async function(t,e="#killTable tbody",i=10){if(!t)return void console.error("System ID is required to load the killboard.");function a(t,e=null,i=null){const a=document.createElement("td"),l=document.createElement("div");l.classList.add("image-container"),i&&l.classList.add(i);const n=document.createElement("img");if(n.src=t,e){const t=document.createElement("a");t.href=e,t.target="_blank",t.appendChild(n),l.appendChild(t)}else l.appendChild(n);return a.appendChild(l),a}function l(t){const e=document.createElement("td"),i=document.createElement("div");return i.classList.add("image-container"),i.style.display="flex",i.style.flexDirection="column",i.style.alignItems="center",t.forEach((({url:t,link:e,className:a})=>{const l=document.createElement("div");l.classList.add("image-container"),a&&l.classList.add(a);const n=document.createElement("img");if(n.src=t,e){const t=document.createElement("a");t.href=e,t.target="_blank",t.appendChild(n),l.appendChild(t)}else l.appendChild(n);i.appendChild(l)})),e.appendChild(i),e}clearKillboard(e);const n=await async function(t){try{const e=await fetch(`/killboard.php?systemID=${t}`);if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);const i=await e.json();if(i.error)throw new Error(i.error);return i}catch(t){return console.error("Error fetching killboard data:",t),[]}}(t),r=document.querySelector(e),c=n.kills.slice(0,i);for(const t of c)try{const e=document.createElement("tr"),i=new Date(t.killmail_time),n=i.toLocaleString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1,timeZone:"UTC"}),c=i.toLocaleString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric",timeZone:"UTC"}),o=document.createElement("td");o.innerHTML=`\n        <div id="killTime">${n} UTC</div>\n        <div id="killDate">${c}</div>\n        <div id="killValue">${Number(t.total_value).toLocaleString()} ISK</div>\n      `,o.style.textAlign="center",e.appendChild(o);const d=[{url:`https://images.evetech.net/corporations/${t.victim_corp}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${t.victim_corp}`,className:"corporation-logo"}];t.victim_alliance&&"0"!==t.victim_alliance&&d.push({url:`https://images.evetech.net/alliances/${t.victim_alliance}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${t.victim_alliance}/`,className:"alliance-logo"}),e.appendChild(l(d)),e.appendChild(a(`https://images.evetech.net/characters/${t.victim_id}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${t.victim_id}`,"victim-portrait")),e.appendChild(a(`https://images.evetech.net/types/${t.victim_ship}/render?size=64`,`https://zkillboard.com/kill/${t.killmail_id}`,"victim-image")),e.appendChild(a(`https://images.evetech.net/types/${t.attacker_ship}/render?size=64`,`https://zkillboard.com/kill/${t.killmail_id}`,"attacker-image")),e.appendChild(a(`https://images.evetech.net/characters/${t.attacker_id}/portrait?tenant=tranquility&size=32`,`https://zkillboard.com/character/${t.attacker_id}`,"attacker-portrait"));const s=[{url:`https://images.evetech.net/corporations/${t.attacker_corp}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/corporation/${t.attacker_corp}`,className:"corporation-logo"}];t.attacker_alliance&&"0"!==t.attacker_alliance&&s.push({url:`https://images.evetech.net/alliances/${t.attacker_alliance}/logo?tenant=tranquility&size=32`,link:`https://zkillboard.com/alliance/${t.attacker_alliance}/`,className:"alliance-logo"}),e.appendChild(l(s)),r.appendChild(e)}catch(t){console.warn(`Failed to fetch killmail ${killmail_id}:`,t)}},window.clearKillboard=function(t="#killTable tbody"){const e=document.querySelector(t);e&&(e.innerHTML="")},window.addEventListener("DOMContentLoaded",(()=>{loadKillboard()}));
...
var activity=new function(){this.graph,this.options,this.view,this.span=24,this.columns=[{id:"time",label:"Time",role:"domain",type:"string",calc:function(i,t){return i.getValue(t,0)+"h"}},{id:"jumps",label:"Jumps",role:"data",type:"number",sourceColumn:1,column:1,title:"Jumps"},{id:"podkills",label:"Pod Kills",role:"data",type:"number",sourceColumn:2,column:2,title:"Pod Kills"},{id:"shipkills",label:"Ship Kills",role:"data",type:"number",sourceColumn:3,column:3,title:"Ship Kills"},{id:"npckills",label:"NPC Kills",role:"data",type:"number",sourceColumn:4,column:4,title:"NPC Kills"}],this.getData=function(i,t){i=void 0!==i?i:this.span,t=void 0===t||t;return activity.graph?$.ajax({url:"activity_graph.php",data:{systemID:viewingSystemID,time:i},type:"GET",dataType:"JSON",cache:t}).done((function(i){i&&!0===i.systemData?(i.rows.reverse(),activity.view=new google.visualization.DataView(new google.visualization.DataTable(i)),activity.view.setColumns(activity.columns),activity.graph.draw(activity.view,activity.options),$("#graphBoard").css("display","block"),$("#killBoard").css("display","none")):(i.rows.reverse(),activity.view=new google.visualization.DataView(new google.visualization.DataTable(i)),activity.view.setColumns(activity.columns),activity.graph.draw(activity.view,activity.options),$("#graphBoard").css("display","none"),$("#killBoard").css("display","block"))})).fail((function(i,t,a){console.error("AJAX request failed: "+t,a),$("#graphBoard").css("display","none"),$("#killBoard").css("display","block")})):(setTimeout((function(){activity.getData(i,t)}),500),!1)},this.selectHandler=function(){var i=activity.graph.getSelection();if(i[0]&&null==i[0].row){var t=i[0].column;activity.columns[t].sourceColumn?(activity.columns[t].label=activity.columns[t].title+" (off)",delete activity.columns[t].sourceColumn):(activity.columns[t].sourceColumn=activity.columns[t].column,activity.columns[t].label=activity.columns[t].title),activity.view.setColumns(activity.columns),activity.options.animation.duration=0,activity.graph.draw(activity.view,activity.options),activity.options.animation.duration=500}},this.init=function(){activity.graph=new google.visualization.AreaChart(document.getElementById("activityGraph")),activity.options={isStacked:!1,backgroundColor:"transparent",hAxis:{textStyle:{color:"#999",fontName:"Verdana",fontSize:10},showTextEvery:3},vAxis:{textStyle:{color:"#666",fontName:"Verdana",fontSize:10},viewWindowMode:"maximized",viewWindow:{min:0},maxValue:5},gridlineColor:"#454545",pointSize:2,lineWidth:1,height:150,chartArea:{left:"10%",top:"5%",width:"88%",height:"85%"},legend:{position:"in",textStyle:{color:"#CCC",fontName:"Verdana",fontSize:8.5}},animation:{duration:500,easing:"inAndout"},tooltip:{showColorCode:!0},annotations:{style:"line",textStyle:{fontSize:12,color:"#ccc"},domain:0},focusTarget:"category"},google.visualization.events.addListener(activity.graph,"select",activity.selectHandler),activity.getData(activity.span)},this.time=function(i){switch(i){case 24:this.options.hAxis.showTextEvery=3;break;case 48:this.options.hAxis.showTextEvery=6;break;case 168:this.options.hAxis.showTextEvery=24}this.span=i,this.getData(i)},this.redraw=function(){this.graph.draw(this.view,this.options)},this.refresh=function(i){this.getData(this.span,i)},google.charts.setOnLoadCallback(this.init)};
