...
const commentCache=new Map,commentCACHE_DURATION=3e5;function filterComments(e){const t=collectSystemIDs(),n=e.commentlist.commentlist.filter((e=>t.includes(e.systemID.toString())));return $("#chainMap div.node").removeClass("commentNode"),n.forEach((e=>{$("#chainMap [data-nodeid='"+e.systemID+"']").addClass("commentNode")})),n}bustCache=function(e){e.data=null,e.timestamp=0,console.log("Cache busted")},commentData=function(){const e=Date.now();return commentCache.data&&e-commentCache.timestamp<3e5?Promise.resolve(filterComments(commentCache.data)):$.ajax({url:"commentlist.php",type:"GET",dataType:"JSON"}).then((function(e){return commentCache.data=e,commentCache.timestamp=Date.now(),filterComments(e)})).fail((function(e,t,n){return console.error("AJAX request failed: "+t,n),[]}))},collectSystemIDs=function(){const e=[];return document.querySelectorAll("#chainMap [data-nodeid]").forEach((t=>{const n=t.getAttribute("data-nodeid");n&&!e.includes(n)&&e.push(n)})),e};
